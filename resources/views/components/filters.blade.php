<div class="d-flex gap-2 justify-content-center mb-1">
  <button type="button" class="btn btn-sm btn-outline-primary me-2 active">Filter one</button>
  <button type="button" class="btn btn-sm btn-outline-primary me-2">Filter two</button>
  <button type="button" class="btn btn-sm btn-outline-secondary me-2">Filter three</button>
  <button type="button" class="btn btn-sm btn-outline-success me-2">Success</button>
  <button type="button" class="btn btn-sm btn-outline-danger me-2">Danger</button>

  <button type="button" class="btn btn-outline-dark me-2">Dark</button>
</div>
